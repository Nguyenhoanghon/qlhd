				...
				<Table  striped bordered hover size="sm">
					...
					<tbody>
						...
						<tr>
							...
							<td>{params.id}</td>
							<td>
							<a href={`/implementation-cost/contract/${params.id}`}> Click nhập</a>
							</td>
						</tr>
						<tr>
							<td>3</td>
							...
							<td>{params.id}</td>
							<td>
							<a href={`/CapitalExpenditureCost/contract/${params.id}`}> Click nhập</a>
							</td>
						</tr>
						<tr>
							<td>4</td>
							...
							<td>{params.id}</td>
							<td>
							<a href={`/manday-cost/contract/${params.id}`}> Click nhập</a>
							</td>
						</tr>
						<tr>
							<td>5</td>
							...
							<td>{params.id}</td>
							<td>
							<a href={`/guarantee-letter-cost/contract/${params.id}`}> Click nhập</a>
							</td>
						</tr>
						<tr>
							<td>6</td>
							...
							<td>{params.id}</td>
							<td>
							<a href={`/MiscExpenseCost/contract/${params.id}`}> Click nhập</a>
							</td>
						</tr>
						<tr>
							<td>7</td>
