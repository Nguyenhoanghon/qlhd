...
const MisExpense_export = () => {
	const {
		MiscExpenseCostState: { MiscExpenseCosts },
	...
	return (
			<ExcelFile
				...
				element={<button type="button" className="btn btn-success">Export MisExpense</button>}>
				<ExcelSheet dataSet={DataSetExport} name="MiscExpenseCosts" />
			</ExcelFile>	
	)
}

export default MisExpense_export
