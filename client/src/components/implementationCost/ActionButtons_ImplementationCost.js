...
const ActionButtons_ImplementationCost = ({ _id }) => {
	const { deleteImplementationCost, findImplementationCost, setShowUpdateImplementationCostModal } = useContext(
	...
	return (
		<>
			...
			<Button className='post-button' onClick={deleteImplementationCost.bind(this, _id)}>
